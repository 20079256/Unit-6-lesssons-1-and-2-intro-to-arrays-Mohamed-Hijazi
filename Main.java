...
//String [] words = {"Have","a","nice","day"};   right right right
//String words [] = {"Have","a","nice","day"};    wrong wrong wrong
...
//set flag if word has more 4 letters
boolean flag=false;
for(int index = 0; index <words.length;index++)
{
...
System.out.println("where there any words with more than four letters?"+flag);
